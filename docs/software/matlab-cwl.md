...
στην υπηρεσία κεντρικής ταυτοποίησης του ΕΜΠ. Μετά την επιτυχή κεντρική ταυτοποίηση από το ΕΜΠ στο Mathworks portal, ακολουθεί η δημιουργία Mathworks account, που συσχετίζεται με το Ιδρυματικό αναγνωριστικό σας. Εκεί θα σας ζητηθεί το email σας, που στη συνέχεια θα πρέπει να το επιβεβαιώσετε, συνεπώς πρέπει να εισάγετε μια πραγματική διεύθυνση, π.χ. `username@mail.ntua.gr` **και όχι `username@ntua.gr`**.
